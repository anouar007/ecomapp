                            ...
                            <div class="col-5 col-md-4 d-flex align-items-center justify-content-center bg-light">
                                <div class="pdp-price text-center" id="priceContainer">
                                    <?php if($product->isOnSale()): ?>
                                        <div class="h5 fw-bold text-gold m-0" id="displayPrice"><?php echo e($product->formatted_sale_price); ?></div>
                                        <div class="text-danger text-decoration-line-through small font-body mt-1" id="originalPrice" style="font-size: 0.85rem;"><?php echo e($product->formatted_price); ?></div>
                                    <?php else: ?>
                                        <div class="h5 fw-bold text-gold m-0" id="displayPrice"><?php echo e($product->formatted_price); ?></div>
