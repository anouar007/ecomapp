...
<div style="padding: 24px; max-width: 1000px; margin: 0 auto;">
    ...
    <div style="background: white; border-radius: 16px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px rgba(0,0,0,0.05); overflow: hidden;">
        <form action="<?php echo e(route('invoices.store')); ?>" method="POST" style="padding: 32px;" id="invoiceForm">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-bottom: 32px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 20px;">
                    <div>
                        ...
                        <input type="text" name="customer_name" id="customer_name" required value="<?php echo e(old('customer_name')); ?>"
                    ...
                    <div>
                        ...
                        <input type="email" name="customer_email" id="customer_email" value="<?php echo e(old('customer_email')); ?>"
                               style="width: 100%; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14px; outline: none;">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 20px;">
                    <div>
                        ...
                        <input type="text" name="customer_phone" id="customer_phone" value="<?php echo e(old('customer_phone')); ?>"
                               style="width: 100%; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14px; outline: none;">
                    </div>
                    <div>
                        <label style="display: block; font-size: 14px; font-weight: 600; color: #64748b; margin-bottom: 8px;">Address</label>
                        <input type="text" name="customer_address" id="customer_address" value="<?php echo e(old('customer_address')); ?>"
                               style="width: 100%; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14px; outline: none;">
                    </div>
                </div>
            </div>
            ...
            <div style="margin-bottom: 32px;">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="4"
                              style="width: 100%; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14px; outline: none;"><?php echo e(old('notes')); ?></textarea>
                </div>
            </div>
        ...
        <td style="padding: 12px;">
            <select name="items[{index}][product_id]" class="product-select" onchange="updateItem(this)" required
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($product->id); ?>" data-price="<?php echo e($product->price); ?>"><?php echo e($product->translated_name); ?> (<?php echo e(number_format($product->price, 2)); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </td>
        <td style="padding: 12px;">
...
<script>
    ...
    const currencyPosition = "<?php echo e(setting('currency_position', 'before')); ?>"; // before or after
    ...
    function updateTotals() {
        ...
        const taxRate = <?php echo e(setting('tax_rate', 10)); ?> / 100;
        ...
        if(taxLabel) taxLabel.textContent = `Tax ($<?php echo e(setting('tax_rate', 10)); ?>%):`;
    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/invoices/create.blade.php ENDPATH**/ ?>