                    ...
                    <div class="brand-card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="code" class="form-control font-monospace" value="<?php echo e(old('code')); ?>" placeholder="e.g. SAVE20" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="e.g. Summer Sale 20%" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <select name="type" class="form-select" id="couponType" required>
                                    ...
                                    <option value="buy_x_get_y" <?php echo e(old('type') == 'buy_x_get_y' ? 'selected' : ''); ?>>Buy X Get Y</option>
                                </select>
                            </div>
                            <div class="col-md-4" id="valueField">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="value" class="form-control" value="<?php echo e(old('value')); ?>">
                        ...
                        <div class="row mb-3 p-3 bg-light rounded" id="buyXGetYFields" style="display: none;">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="buy_quantity" class="form-control" value="<?php echo e(old('buy_quantity')); ?>" min="1">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold small text-uppercase">Get Quantity (Y) <span class="text-danger">*</span></label>
                                <input type="number" name="get_quantity" class="form-control" value="<?php echo e(old('get_quantity')); ?>" min="1">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="valid_to" class="form-control" value="<?php echo e(old('valid_to')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="brand-card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="usage_limit" class="form-control" value="<?php echo e(old('usage_limit')); ?>" min="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="per_customer_limit" class="form-control" value="<?php echo e(old('per_customer_limit')); ?>" min="1">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="firstOrderOnly" name="first_order_only" value="1" <?php echo e(old('first_order_only') ? 'checked' : ''); ?>>
                    ...
                    <div class="brand-card-body">
                        <div class="mb-3">
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="applicable_to" id="applyAll" value="all" <?php echo e(old('applicable_to', 'all') == 'all' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="applyAll">All Products</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="applicable_to" id="applyProducts" value="specific_products" <?php echo e(old('applicable_to') == 'specific_products' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="applyProducts">Specific Products</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="applicable_to" id="applyCategories" value="specific_categories" <?php echo e(old('applicable_to') == 'specific_categories' ? 'checked' : ''); ?>>
                        ...
                        <div id="productSelect" style="display: none;" class="mb-3">
                            ...
                            <select name="applicable_ids[]" class="form-select" multiple size="5">
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($product->id); ?>"><?php echo e($product->translated_name); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/coupons/create.blade.php ENDPATH**/ ?>