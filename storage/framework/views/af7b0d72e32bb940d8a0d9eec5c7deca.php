<?php $__env->startSection('meta_title', __('Checkout') . ' — Ait Oumdis'); ?>
    ...
    <div class="container position-relative" style="z-index:1">
        <div class="text-center mb-4">
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('cart.index')); ?>" class="text-white opacity-60 text-decoration-none small"><?php echo e(__('Cart')); ?></a></li>
                    <li class="breadcrumb-item active text-white small"><?php echo e(__('Checkout')); ?></li>
                </ol>
            </nav>
            <h1 class="text-white fw-900 mb-2" style="font-size:clamp(1.6rem,3vw,2.2rem)"><?php echo e(__('Complete Your Order')); ?></h1>
            <p class="text-white mb-0" style="opacity:.7;font-size:.9rem"><?php echo e(__('Just a few details away from getting your natural products')); ?></p>
        </div>
        ...
        <div class="co-steps">
            <div class="co-step">
                ...
                <span class="co-step-label text-white"><?php echo e(__('Delivery')); ?></span>
            </div>
            <div class="co-step-line"></div>
            <div class="co-step">
                <div class="co-step-num" style="background:rgba(255,255,255,.25)">2</div>
                <span class="co-step-label text-white opacity-60"><?php echo e(__('Confirm')); ?></span>
            </div>
            <div class="co-step-line"></div>
            <div class="co-step">
                <div class="co-step-num" style="background:rgba(255,255,255,.25)">3</div>
                <span class="co-step-label text-white opacity-60"><?php echo e(__('Done')); ?></span>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-7">
                ...
                <div class="co-card mb-4">
                    <div class="co-card-title">
                        ...
                        <?php echo e(__('Delivery Information')); ?>
                    ...
                    <form action="<?php echo e(route('checkout.store')); ?>" method="POST" id="checkoutForm">
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div>
                                <label class="co-label"><?php echo e(__('Full Name')); ?></label>
                                <input type="text" name="customer_name" class="co-input"
                                       placeholder="<?php echo e(__('Example: Ahmed Alami')); ?>"
                                       value="<?php echo e(old('customer_name')); ?>" required>
                            </div>

                            
                            <div>
                                <label class="co-label"><?php echo e(__('Phone Number')); ?></label>
                                ...
                                <label class="co-label"><?php echo e(__('City')); ?></label>
                                <select id="city-select">
                                    <option value=""><?php echo e(__('Search for your city...')); ?></option>
                                </select>

                            
                            <div>
                                <label class="co-label"><?php echo e(__('Detailed Address')); ?></label>
                                <textarea name="shipping_address" class="co-input" rows="3"
                                          placeholder="<?php echo e(__('Neighborhood, street, house number...')); ?>"
                        ...
                        <div class="co-payment mt-4">
                            ...
                            <div>
                                <div class="fw-800 text-dark mb-1" style="font-size:.93rem"><?php echo e(__('Cash on Delivery')); ?></div>
                                <div class="small text-muted"><?php echo e(__('Our team will contact you to confirm the order before shipping')); ?></div>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn-co-submit mt-4">
                            ...
                            <?php echo e(__('Confirm My Order')); ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="text-center p-3 bg-white rounded-3 border" style="border-color:#f1f5f9!important">
                            <i class="<?php echo e($r[0]); ?> text-green mb-2" style="font-size:1.1rem"></i>
                            <div class="fw-800 text-dark mb-0" style="font-size:.75rem"><?php echo e($r[1]); ?></div>
                            <div class="text-muted" style="font-size:.68rem"><?php echo e($r[2]); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="co-summary">
                        ...
                        <div>
                            ...
                            <div class="co-item">
                                <div class="co-item-img">
                                    <img src="<?php echo e($details['image'] ? Storage::url($details['image']) : asset('images/placeholder-product.jpg')); ?>"
                                         alt="<?php echo e($details['name']); ?>">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="co-item-name"><?php echo e($details['name']); ?></div>
                                    <div class="d-flex gap-1 flex-wrap mt-1">
                                        <?php if($details['size'] ?? null): ?>
                                            <span class="co-item-size"><?php echo e($details['size']); ?></span>
                                        <?php endif; ?>
                                        <span class="co-item-qty">×<?php echo e($details['quantity']); ?></span>
                                    </div>
                                    <div class="co-item-price"><?php echo e(currency($details['price'] * $details['quantity'])); ?></div>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="co-totals">
                            <div class="co-totals-row">
                                <span class="co-total-label"><?php echo e(__('Subtotal')); ?></span>
                                <span class="co-total-value"><?php echo e(currency($total)); ?></span>
                            </div>
                            <div class="co-totals-row mt-2">
                                <span class="co-total-label"><?php echo e(__('Delivery')); ?></span>
                                <span class="co-total-value text-green fw-800" id="shippingDisplay"><?php echo e(__('Select city...')); ?></span>
                            </div>
                            <div class="co-totals-divider"></div>
                            <div class="co-totals-row">
                                <span class="co-grand-label"><?php echo e(__('Total')); ?></span>
                                <span class="co-grand-value" id="totalDisplay"><?php echo e(currency($total)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="co-secure">
                            ...
                            <span><?php echo e(__('Secure & Encrypted Checkout')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const cities = <?php echo json_encode($cities->values(), 15, 512) ?>;
        ...
        const options = cities.map(c => {
            cityMap[c.id] = c;
            const primaryName = '<?php echo e(app()->getLocale()); ?>' === 'ar' ? c.arabic_name : c.name;
            const secondaryName = '<?php echo e(app()->getLocale()); ?>' === 'ar' ? c.name : c.arabic_name;
            return {
                value: String(c.id),
        ...
        const ts = new TomSelect('#city-select', {
            ...
            labelField: 'text',
            searchField: ['text'],
            placeholder: '<?php echo e(__("Search for your city...")); ?>',
            onChange: function(value) {
                ...
                if (city) {
                    ...
                    document.getElementById('shippingDisplay').innerText = parseFloat(city.price).toFixed(2) + ' <?php echo e(__('DH')); ?>';
                    document.getElementById('totalDisplay').innerText = (subtotal + parseFloat(city.price)).toFixed(2) + ' <?php echo e(__('DH')); ?>';
                }
            }
        });
    });
