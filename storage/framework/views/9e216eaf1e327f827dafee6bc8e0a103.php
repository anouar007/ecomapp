    ...
    <div class="container py-3">
        ...
        <div class="cat-masonry-grid">
            ...
            <div class="cat-masonry-featured" data-aos="fade-right" data-aos-delay="0">
                <a href="#" class="cat-masonry-card text-decoration-none" data-slug="<?php echo e($c->slug); ?>">
            ...
            <div class="cat-masonry-right">
                <?php $__currentLoopData = $cats->skip(1)->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div data-aos="fade-left" data-aos-delay="<?php echo e(($i + 1) * 100); ?>">
                    <a href="#" class="cat-masonry-card text-decoration-none" data-slug="<?php echo e($c->slug); ?>">
                        <div class="cat-masonry-inner position-relative overflow-hidden rounded-4">
                            <img src="<?php echo e($c->image ? (Str::startsWith($c->image,'http') ? $c->image : Storage::url($c->image)) : asset('images/placeholder-cat.jpg')); ?>"
                                 class="cat-masonry-img w-100 h-100 object-fit-cover" alt="<?php echo e($c->translated_name); ?>">
                            ...
                            <div class="cat-masonry-content position-absolute w-100" style="bottom:0;left:0;padding:14px;">
                                <h6 class="text-white fw-800 mb-1" style="font-size:0.85rem; line-height: 1.2;"><?php echo e($c->translated_name); ?></h6>
                                <div class="d-flex align-items-center gap-1 opacity-75">
                                    <span class="x-small text-white" style="font-size:0.6rem;"><?php echo e(__('Explore')); ?></span>
                                    <i class="fas fa-arrow-right" style="font-size:0.5rem;color:#3BB878;"></i>
                                </div>
                            </div>
                            
                            <div class="position-absolute top-0 end-0 m-2" style="font-size:2.5rem;font-weight:900;color:rgba(255,255,255,.07);line-height:1;font-family:'Playfair Display',serif;">0<?php echo e($i + 2); ?></div>
                        </div>
                    </a>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="cat-masonry-extra">
                <?php $__currentLoopData = $cats->skip(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div data-aos="fade-up" data-aos-delay="<?php echo e($i * 80); ?>">
                    <a href="#" class="cat-masonry-card text-decoration-none" data-slug="<?php echo e($c->slug); ?>">
                        <div class="cat-masonry-inner position-relative overflow-hidden rounded-4">
                            <img src="<?php echo e($c->image ? (Str::startsWith($c->image,'http') ? $c->image : Storage::url($c->image)) : asset('images/placeholder-cat.jpg')); ?>"
                                 class="cat-masonry-img w-100 h-100 object-fit-cover" alt="<?php echo e($c->translated_name); ?>">
                            ...
                            <div class="cat-masonry-content position-absolute w-100" style="bottom:0;left:0;padding:14px;">
                                <h6 class="text-white fw-800 mb-1" style="font-size:0.85rem; line-height: 1.2;"><?php echo e($c->translated_name); ?></h6>
                                <div class="d-flex align-items-center gap-1 opacity-75">
                                    <span class="x-small text-white" style="font-size:0.6rem;"><?php echo e(__('Explore')); ?> <span class="fa-arrow-right">→</span></span>
                                </div>
                            </div>
                        </div>
                    </a>
...
<section class="py-5 bg-white">
    <div class="container py-3">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="section-label mx-auto"><?php echo e(__('Community Love')); ?></div>
            <h2 class="section-title"><?php echo e(__('What Customers Say')); ?></h2>
            <div class="section-divider mx-auto"></div>
        </div>
        <div class="row g-4">
            <?php $__currentLoopData = [
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="<?php echo e($i * 100); ?>">
                <div class="rounded-4 p-4 h-100 border-0 shadow-sm bg-white position-relative overflow-hidden" style="border-top: 3px solid #3BB878 !important;">
                    ...
                    <div class="mb-3"><?php echo e($t[2]); ?></div>
                    <p class="text-muted small lh-lg mb-4">"<?php echo e($t[3]); ?>"</p>
                    <div class="d-flex align-items-center gap-3">
                        <div class="rounded-circle bg-green d-flex align-items-center justify-content-center fw-800 text-white" style="width:44px;height:44px;flex-shrink:0;"><?php echo e(mb_substr($t[0],0,1)); ?></div>
                        <div>
                            <div class="fw-700 text-dark small"><?php echo e($t[0]); ?></div>
                            <div class="x-small text-muted"><i class="fas fa-map-marker-alt me-1 text-green"></i><?php echo e($t[1]); ?></div>
                        </div>
                    </div>
                </div>
            </div>
