    ...
    <div class="container px-xl-5 text-center hero-fade-in">
        ...
        <div class="mb-3">
            <?php if(setting('app_logo')): ?>
                <img src="<?php echo e(Storage::url(setting('app_logo'))); ?>" alt="<?php echo e(setting('app_name', 'Hijab Princesses')); ?>" class="hero-logo-elegant">
            <?php else: ?>
...
<section class="section-py bg-surface position-relative" style="border-top: 1px solid rgba(0,0,0,0.02);">
    ...
    <div class="text-center mt-5 mb-5 <?php echo e($hasMore ? '' : 'd-none'); ?>" id="load-more-container" data-aos="fade-up">
