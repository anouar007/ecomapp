...
<section class="section-py bg-white overflow-hidden">
    <div class="container px-xl-5">
        ...
        <div class="category-circle-grid" data-aos="fade-up" data-aos-delay="100">
            ...
            <a href="<?php echo e(route('shop.index', ['category' => $category->slug])); ?>" class="category-circle-item text-decoration-none">
                <div class="category-circle-img-wrap">
                    <img src="<?php echo e($category->image ? (Str::startsWith($category->image, 'http') ? $category->image : Storage::url($category->image)) : asset('images/placeholder-cat.jpg')); ?>" alt="<?php echo e($category->translated_name); ?>">
                </div>
                <span class="category-circle-name"><?php echo e($category->translated_name); ?></span>
            </a>
