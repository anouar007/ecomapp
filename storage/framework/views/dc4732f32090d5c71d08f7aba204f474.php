...
<div class="row g-3 g-lg-4 mb-5">
    <div class="col-6 col-md-6" data-aos="fade-up" data-aos-delay="50">
        <div class="brand-card border-0 shadow-sm overflow-hidden bg-gold-gradient text-white h-100 p-4 relative">
            ...
            <h2 class="brand-heading display-5 mb-0"><?php echo e($user->orders()->count()); ?></h2>
        </div>
    </div>
    <div class="col-6 col-md-6" data-aos="fade-up" data-aos-delay="100">
        <div class="brand-card border-0 shadow-sm bg-white h-100 p-4 d-flex flex-column justify-content-center">
            ...
            <p class="mb-1 fw-bold text-dark font-body"><?php echo e($user->name); ?></p>
            <p class="text-muted mb-0 small font-body text-truncate"><?php echo e($user->email); ?></p>
            <a href="<?php echo e(route('customer.profile')); ?>" class="text-gold text-decoration-none small fw-bold mt-2 font-body hvr-forward">تعديل الملف الشخصي <i class="fas fa-arrow-left ms-1 small"></i></a>
        </div>
    </div>
</div>
...
<div class="brand-card border-0 shadow-sm overflow-hidden bg-white" data-aos="fade-up" data-aos-delay="150">
    <div class="card-header bg-white p-4 border-bottom border-light d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('customer.orders')); ?>" class="btn-brand-outline py-1 px-3 small">عرض الكل</a>
    </div>
            ...
            <tbody>
                ...
                <tr class="border-bottom border-light hover-gold-subtle transition-300">
                    ...
                    <td class="pe-4 text-end">
                        <a href="<?php echo e(route('customer.orders.show', $order)); ?>" class="btn btn-sm btn-light hvr-grow rounded-circle p-2">
                ...
                <tr>
                    <td colspan="5" class="text-center py-5">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="btn-brand-primary px-4">ابدئي التسوق الآن</a>
                    </td>
                </tr>
                <?php endif; ?>
            </tbody>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/frontend/dashboard/index.blade.php ENDPATH**/ ?>