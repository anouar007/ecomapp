<div class="brand-card h-100 pcard border-0 position-relative" data-product-id="<?php echo e($product->id); ?>">
    ...
    <div class="product-v2-image pcard-img-reveal position-relative overflow-hidden" style="aspect-ratio: 4/5;">
        ...
        <?php if($product->is_featured || $product->id % 3 == 0): ?>
        ...
        <img src="<?php echo e($mainImgPath); ?>" alt="<?php echo e($product->translated_name); ?>" class="w-100 h-100 object-fit-cover pcard-img-primary">
        
        <?php if($secondaryImg): ?>
            <img src="<?php echo e(Storage::url($secondaryImg->image_path)); ?>" alt="<?php echo e($product->translated_name); ?> - View 2" class="pcard-img-secondary">
        <?php endif; ?>
    </div>
