<?php $__env->startSection('title', __('Journal Entries')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="brand-header">
        <div>
            <h1 class="brand-title">
                ...
                <?php echo e(__('Journal Entries')); ?>

            </h1>
            <p class="brand-subtitle"><?php echo e(__('Track all financial transactions and accounting entries')); ?></p>
        </div>
    ...
    <div class="brand-table-card mb-4">
        <div class="p-4 border-bottom">
            <div class="d-flex align-items-center gap-2">
                ...
                <h5 class="fw-bold text-dark m-0"><?php echo e(__('Filter Entries')); ?></h5>
            </div>
        </div>
        <div class="p-4">
            <form method="GET" action="<?php echo e(route('accounting.entries')); ?>" class="row g-3">
                <div class="col-md-3">
                    <label class="form-label fw-semibold small text-muted"><?php echo e(__('DATE FROM')); ?></label>
                    <input type="date" name="start_date" class="form-control" value="<?php echo e(request('start_date')); ?>" style="border-radius: 8px;">
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold small text-muted"><?php echo e(__('DATE TO')); ?></label>
                    <input type="date" name="end_date" class="form-control" value="<?php echo e(request('end_date')); ?>" style="border-radius: 8px;">
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold small text-muted"><?php echo e(__('JOURNAL TYPE')); ?></label>
                    <select name="journal_type" class="form-select" style="border-radius: 8px;">
                        <option value=""><?php echo e(__('All Types')); ?></option>
                        <?php $__currentLoopData = ['SALES', 'PURCHASES', 'BANK', 'CASH', 'OD', 'GENERAL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type); ?>" <?php echo e(request('journal_type') == $type ? 'selected' : ''); ?>><?php echo e($type); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold small text-muted"><?php echo e(__('SEARCH')); ?></label>
                    <input type="text" name="search" class="form-control" placeholder="<?php echo e(__('Ref or Description')); ?>" value="<?php echo e(request('search')); ?>" style="border-radius: 8px;">
                </div>
                <div class="col-12 d-flex gap-2 justify-content-end">
                    <a href="<?php echo e(route('accounting.entries')); ?>" class="btn-brand-outline px-4">
                        <i class="fas fa-redo me-2"></i> <?php echo e(__('Reset')); ?>

                    </a>
                    <button type="submit" class="btn-brand-primary px-4">
                        <i class="fas fa-search me-2"></i> <?php echo e(__('Filter')); ?>
            ...
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px;">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <p class="text-white-50 mb-1 small"><?php echo e(__('Total Entries')); ?></p>
                            <h4 class="text-white fw-bold mb-0"><?php echo e($entries->total()); ?></h4>
                        </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 12px;">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <p class="text-white-50 mb-1 small"><?php echo e(__('This Page')); ?></p>
                            <h4 class="text-white fw-bold mb-0"><?php echo e($entries->count()); ?></h4>
                        </div>
                        <div class="brand-avatar" style="background: rgba(255,255,255,0.2); color: white; width: 48px; height: 48px; font-size: 20px;">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 12px;">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <p class="text-white-50 mb-1 small"><?php echo e(__('Current Page')); ?></p>
                            <h4 class="text-white fw-bold mb-0"><?php echo e($entries->currentPage()); ?> / <?php echo e($entries->lastPage()); ?></h4>
                        </div>
                        <div class="brand-avatar" style="background: rgba(255,255,255,0.2); color: white; width: 48px; height: 48px; font-size: 20px;">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); border-radius: 12px;">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <p class="text-white-50 mb-1 small"><?php echo e(__('Filters Active')); ?></p>
                            <h4 class="text-white fw-bold mb-0"><?php echo e((request('start_date') || request('end_date') || request('journal_type') || request('search')) ? __('Yes') : __('No')); ?></h4>
                        </div>
                        <div class="brand-avatar" style="background: rgba(255,255,255,0.2); color: white; width: 48px; height: 48px; font-size: 20px;">
            ...
            <table class="brand-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 180px;"><?php echo e(__('Reference')); ?></th>
                        <th><?php echo e(__('Description')); ?></th>
                        <th style="width: 110px;"><?php echo e(__('Journal')); ?></th>
                        <th style="width: 120px; text-align: center;"><?php echo e(__('Balance')); ?></th>
                        <th style="width: 140px; text-align: center; padding-right: 1.5rem;"><?php echo e(__('Actions')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="journal-entry-row" style="border-bottom: 1px solid #f1f5f9;" data-entry-id="<?php echo e($entry->id); ?>">
                        <td style="padding: 1.25rem 0 1.25rem 1.5rem;">
                            <button class="btn btn-sm toggle-details" style="background: transparent; border: none; color: #6366f1; padding: 0; transition: transform 0.2s;" onclick="toggleDetails(<?php echo e($entry->id); ?>)" title="Show/Hide Details">
                                <i class="fas fa-chevron-right" id="icon-<?php echo e($entry->id); ?>"></i>
                            </button>
                        </td>
                        <td style="padding: 1.25rem 0; white-space: nowrap;">
                            <div class="d-flex flex-column">
                                <span class="text-dark fw-bold" style="font-size: 0.9rem;"><?php echo e($entry->date->format('M d, Y')); ?></span>
                                <span class="text-muted small"><?php echo e($entry->date->format('D')); ?></span>
                            </div>
                        </td>
                        ...
                        <td style="padding: 1.25rem 0;">
                            <div class="d-flex flex-column">
                                <span class="text-dark fw-semibold"><?php echo e($entry->description); ?></span>
                                <span class="text-muted small">
                                    <i class="fas fa-list-ul me-1" style="font-size: 0.7rem;"></i>
                                    <?php echo e($entry->lines->count()); ?> <?php echo e($entry->lines->count() > 1 ? __('line items') : __('line item')); ?>
                        ...
                        <td style="padding: 1.25rem 0;">
                            <span class="brand-badge 
                                <?php if($entry->journal_type === 'SALES'): ?> success
                                <?php elseif($entry->journal_type === 'PURCHASES'): ?> warning
                                <?php elseif(in_array($entry->journal_type, ['BANK', 'CASH'])): ?> info
                                <?php else: ?> secondary
                                <?php endif; ?>" style="font-size: 0.75rem; font-weight: 600;">
                                <?php echo e($entry->journal_type); ?>
                    ...
                    <tr id="details-<?php echo e($entry->id); ?>" class="details-row" style="display: none; background: linear-gradient(135deg, #f8f9ff 0%, #fafbfc 100%);">
                            ...
                            <div class="p-4 pb-3" style="border-left: 4px solid #6366f1;">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h6 class="fw-bold text-dark m-0 d-flex align-items-center gap-2" style="font-size: 0.95rem;">
                                        ...
                                        <span><?php echo e(__('Transaction Details')); ?></span>
                                    </h6>
                                    <span class="badge" style="background: linear-gradient(135deg, #f0f0ff 0%, #e8e8ff 100%); color: #6366f1; font-weight: 600; padding: 0.4rem 0.8rem; border-radius: 6px; font-size: 0.75rem;">
                                        ...
                                        <?php echo e($entry->lines->count()); ?> <?php echo e($entry->lines->count() > 1 ? __('Lines') : __('Line')); ?>
                                        ...
                                        <thead style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-bottom: 2px solid #e2e8f0;">
                                            <tr>
                                                <th style="padding: 0.85rem 1rem; font-weight: 700; color: #1e293b; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.5px;">
                                                    <i class="fas fa-building me-2" style="color: #6366f1; font-size: 0.65rem;"></i><?php echo e(__('Account')); ?>
                                                ...
                                                <th class="text-end" style="padding: 0.85rem 1rem; font-weight: 700; color: #1e293b; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.5px; width: 180px;">
                                                    <i class="fas fa-arrow-up me-2" style="color: #059669; font-size: 0.65rem;"></i><?php echo e(__('Debit')); ?>

                                                </th>
                                                <th class="text-end" style="padding: 0.85rem 1rem; font-weight: 700; color: #1e293b; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.5px; width: 180px;">
                                                    <i class="fas fa-arrow-down me-2" style="color: #dc2626; font-size: 0.65rem;"></i><?php echo e(__('Credit')); ?>

                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $__currentLoopData = $entry->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <td style="padding: 0.75rem 1rem;">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="text-dark fw-semibold" style="font-size: 0.85rem;"><?php echo e($line->account->name); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end" style="padding: 0.75rem 1rem; vertical-align: middle;">
                                                    <?php if($line->debit > 0): ?>
                                                        <span class="badge" style="background: linear-gradient(135deg, #dcfce7 0%, #d1fae5 100%); color: #166534; font-weight: 700; font-size: 0.75rem; padding: 0.4rem 0.8rem; border-radius: 6px; border: 1px solid #86efac; box-shadow: 0 1px 3px rgba(22,101,52,0.08);">
                                                            ...
                                                            <?php echo e(number_format($line->debit, 2)); ?>
                                                ...
                                                <td class="text-end" style="padding: 0.75rem 1rem; vertical-align: middle;">
                                                    <?php if($line->credit > 0): ?>
                                                        <span class="badge" style="background: linear-gradient(135deg, #fee2e2 0%, #fecaca 100%); color: #991b1b; font-weight: 700; font-size: 0.75rem; padding: 0.4rem 0.8rem; border-radius: 6px; border: 1px solid #fca5a5; box-shadow: 0 1px 3px rgba(153,27,27,0.08);">
                                                            ...
                                                            <?php echo e(number_format($line->credit, 2)); ?>
                                            ...
                                            <tr style="background: linear-gradient(135deg, #f8fafc 0%, #eef2ff 100%); border-top: 2px solid #6366f1;">
                                                <td class="text-end fw-bold" style="padding: 0.85rem 1rem; color: #1e293b; font-size: 0.85rem;">
                                                    <div style="display: inline-flex; align-items: center; gap: 0.6rem;">
                                                        ...
                                                        <span style="font-weight: 700; font-size: 0.85rem;"><?php echo e(__('TOTAL')); ?></span>
                                                    </div>
                                                </td>
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="text-center py-5">
                                ...
                                <h6 class="fw-bold text-dark mb-2" style="font-size: 1.1rem;"><?php echo e(__('No Entries Found')); ?></h6>
                                <p class="text-muted small mb-4"><?php echo __('There are no journal entries matching your criteria.<br>Create your first entry to start tracking transactions.'); ?></p>
                                <a href="<?php echo e(route('accounting.entries.create')); ?>" class="btn-brand-primary shadow" style="padding: 0.65rem 1.5rem;">
                                    <i class="fas fa-plus me-2"></i> <?php echo e(__('Create First Entry')); ?>
    ...
    <script>
        ...
        function confirmDelete(entryId) {
            if (confirm("<?php echo e(__('Are you sure you want to delete this journal entry? This action cannot be undone.')); ?>")) {
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if ((e.ctrlKey || e.metaKey) && e.key === 'n') {
                e.preventDefault();
                window.location.href = '<?php echo e(route('accounting.entries.create')); ?>';
            }
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/accounting/entries.blade.php ENDPATH**/ ?>