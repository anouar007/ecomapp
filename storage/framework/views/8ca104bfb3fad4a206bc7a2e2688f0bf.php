<?php $__env->startSection('title', __('POS Terminal')); ?>
    ...
    <div class="pos-products-area">
        <div class="pos-header">
            <div class="search-container">
                ...
                <input type="text" id="searchInput" class="search-input" placeholder="<?php echo e(__('Search products by name or SKU...')); ?>" autofocus>
            </div>
            <div style="font-weight: 700; color: #334155; display: flex; align-items: center; margin-left: 20px;">
                ...
                <div style="display: none; @media(min-width: 768px){display:block;}">
                    <div style="font-size: 16px; color: #1e293b;"><?php echo e(__('POS')); ?>-<?php echo e(str_pad(auth()->id(), 3, '0', STR_PAD_LEFT)); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="categories-wrapper">
            <div class="category-pills">
                <div class="category-pill category-btn active" data-category=""><?php echo e(__('All Items')); ?></div>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="category-pill category-btn" data-category="<?php echo e($category->id); ?>"><?php echo e($category->translated_name); ?></div>
        ...
        <div class="products-grid" id="productsGrid">
            ...
            <div style="grid-column: 1/-1; text-align: center; padding-top: 100px; color: #94a3b8;">
                ...
                <p style="margin-top: 16px; font-weight: 500;"><?php echo e(__('Loading catalog...')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="pos-order-wrapper" id="pos-order-wrapper">
        ...
        <div class="cart-items-panel">
            <div class="panel-header">
                ...
                <button onclick="clearCart()" title="<?php echo e(__('Clear Cart (F4)')); ?>" style="background: #fee2e2; color: #ef4444; border: none; width: 32px; height: 32px; border-radius: 8px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.2s;">
            ...
            <div class="items-list" id="cartItems">
                ...
                <div style="text-align: center; margin-top: 60px; color: #94a3b8;">
                    ...
                    <h3 style="font-size: 14px; font-weight: 600; color: #64748b;"><?php echo e(__('Empty Cart')); ?></h3>
                    <p style="font-size: 12px; margin-top: 4px;"><?php echo e(__('Click products to add')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="order-form-panel">
            ...
            <div class="panel-content">
                ...
                <div style="margin-bottom: 16px;">
                    <label style="font-size: 11px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.8px; margin-bottom: 6px; display: block;"><?php echo e(__('Customer')); ?></label>
                    <select id="customerSelect" class="compact-input" style="background: white; cursor: pointer; font-size: 13px;">
                        <option value="">🚶 <?php echo e(__('Walk-in Customer')); ?></option>
                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($customer->id); ?>" 
                                    ...
                                    data-credit-limit="<?php echo e($customer->credit_limit); ?>"
                                    data-balance="<?php echo e($customer->current_balance); ?>">
                                <?php echo e($customer->name); ?> (<?php echo e($customer->customer_code); ?>)
                                <?php if($customer->credit_limit > 0): ?>
                                    - <?php echo e(__('Credit:')); ?> <?php echo e(currency($customer->credit_limit)); ?>
                ...
                <div id="customerInfo" style="display: none; padding: 10px; background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); border-radius: 8px; margin-bottom: 16px; box-shadow: 0 2px 8px rgba(99, 102, 241, 0.25);">
                    ...
                    <div id="creditInfo" style="display: none; margin-top: 8px; padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.2);">
                        <div style="display: flex; justify-content: space-between; align-items: center; font-size: 10px; margin-bottom: 4px;">
                            <span style="color: rgba(255,255,255,0.9);"><?php echo e(__('Credit:')); ?></span>
                ...
                <input type="hidden" id="customerName" value="<?php echo e(__('Walk-in Customer')); ?>">
                <input type="hidden" id="customerEmail">
                <input type="hidden" id="customerPhone">
                
                <!-- Discount Input -->
                <div style="margin-bottom: 16px;">
                    <label style="font-size: 11px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.8px; margin-bottom: 6px; display: block;"><?php echo e(__('Discount')); ?></label>
                ...
                <!-- Payment Method -->
                <div style="margin-bottom: 16px;">
                    <label style="font-size: 11px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.8px; margin-bottom: 6px; display: block;"><?php echo e(__('Payment')); ?></label>
                    <select id="paymentMethod" class="compact-input" style="background: white; font-size: 13px;">
                        ...
                        <option value="card">💳 <?php echo e(__('Credit Card')); ?></option>
                        <option value="mobile">📱 <?php echo e(__('Mobile Payment')); ?></option>
                        <option value="credit" id="creditOption" disabled style="color: #9ca3af;">🏦 <?php echo e(__('On Credit')); ?></option>
            ...
            <div class="order-totals">
                <div class="bill-row">
                    ...
                    <span id="subtotal" style="font-weight: 600; color: #1e293b;"><?php echo e(currency(0)); ?></span>
                </div>
                <div class="bill-row" id="discountRow" style="display: none;">
                    <span><?php echo e(__('Discount')); ?></span>
                    <span id="discountDisplay" style="font-weight: 600; color: #10b981;">-<?php echo e(currency(0)); ?></span>
                </div>
                <div class="bill-row">
                    <span><?php echo e(__('Tax')); ?> (<?php echo e(setting('tax_rate', 0)); ?>%)</span>
                    <span id="tax" style="font-weight: 600; color: #1e293b;"><?php echo e(currency(0)); ?></span>
                </div>
                <div class="bill-total">
                    <span><?php echo e(__('Total')); ?></span>
                    <span id="total" style="color: #6366f1;"><?php echo e(currency(0)); ?></span>
                </div>

                <!-- Keyboard Shortcuts -->
                <div style="margin-top: 10px; font-size: 9px; color: #94a3b8; text-align: center;">
                    <kbd style="background: #e2e8f0; padding: 1px 4px; border-radius: 2px; font-family: monospace;">F2</kbd> <?php echo e(__('Search')); ?>

                    <span style="margin: 0 6px;">•</span>
                    <kbd style="background: #e2e8f0; padding: 1px 4px; border-radius: 2px; font-family: monospace;">F4</kbd> <?php echo e(__('Clear')); ?>

                    <span style="margin: 0 6px;">•</span>
                    <kbd style="background: #e2e8f0; padding: 1px 4px; border-radius: 2px; font-family: monospace;">F9</kbd> <?php echo e(__('Pay')); ?>

                </div>

                <button class="pay-btn" id="checkoutBtn" onclick="checkout()" disabled>
                    <?php echo e(__('Charge')); ?> <span class="charge-amount-display"><?php echo e(currency(0)); ?></span>
                </button>
            </div>
        </div>
    </div>
...
<script>
    ...
    window.currencyConfig = {
        symbol: '<?php echo e(setting("currency_symbol", "$")); ?>',
        position: '<?php echo e(setting("currency_position", "before")); ?>',
        decimals: <?php echo e(setting("currency_decimals", 2)); ?>,
        decimal_separator: '<?php echo e(setting("decimal_separator", ".")); ?>',
        thousands_separator: '<?php echo e(setting("thousands_separator", ",")); ?>',
        tax_rate: <?php echo e(setting("tax_rate", 0)); ?> / 100
    };
    ...
    window.customDisplayProducts = function(products) {
        ...
        if (products.length === 0) {
            grid.innerHTML = `
                <div style="grid-column: 1/-1; text-align: center; padding-top: 60px; color: #94a3b8;">
                    ...
                    <p><?php echo e(__('No matching products found')); ?></p>
                </div>
            `;
            return;
        }
        ...
        grid.innerHTML = products.map(product => {
            ...
            if (isOutOfStock) {
                stockBadgeHtml = `<div class="stock-badge out-of-stock"><i class="fas fa-times-circle"></i> <?php echo e(__('Out of Stock')); ?></div>`;
            } else if (product.stock <= 5) {
                stockBadgeHtml = `<div class="stock-badge low-stock"><i class="fas fa-exclamation-triangle"></i> ${product.stock} <?php echo e(__('left')); ?></div>`;
            } else {
            ...
            const saleBadge = product.sale_price && parseFloat(product.sale_price) < parseFloat(product.price) 
                ? `<div class="sale-badge"><?php echo e(__('SALE')); ?></div>` 
                : '';
    ...
    window.customUpdateCartUI = function() {
        ...
        if (cart.length === 0) {
            ...
            document.getElementById('checkoutBtn').innerHTML = `<?php echo e(__('Charge')); ?> ${formatCurrency(0)}`;
        } else {
        ...
        if(cart.length > 0) {
            document.getElementById('checkoutBtn').innerHTML = `<?php echo e(__('Charge')); ?> ${formatCurrency(total)}`;
        }
    };
    ...
    window.addToCartWithFeedback = function(id) {
        ...
        if (product && product.stock > 0) {
            ...
            if(typeof Toast !== 'undefined') {
                Toast.fire({
                    icon: 'success',
                    title: '<?php echo e(__('Added to cart')); ?>',
                    timer: 1000,
...
<script src="<?php echo e(asset('js/pos-customer.js')); ?>"></script>
<script>
    ...
    <button class="mobile-cart-toggle d-none" id="mobile-cart-toggle">
        <div class="d-flex align-items-center gap-3">
            <i class="fas fa-shopping-cart"></i>
            <span><?php echo e(__('View Cart')); ?></span>
        </div>
        <span class="total-badge" id="mobile-total-badge"><?php echo e(currency(0)); ?></span>
    </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const observer = new MutationObserver(() => {
                ...
                if (checkoutBtn) {
                    const totalText = checkoutBtn.innerText.replace('<?php echo e(__("Charge")); ?>', '').trim();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/pos/index.blade.php ENDPATH**/ ?>