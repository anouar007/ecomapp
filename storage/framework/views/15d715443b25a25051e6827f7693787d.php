...
<body>
    <div class="header">
        ...
        <p>Generated on <?php echo e(now()->format('F d, Y \a\t H:i')); ?></p>
    </div>

    <div class="metrics">
        <div class="metric">
            <div class="metric-label">Total Revenue</div>
            <div class="metric-value">$<?php echo e(number_format($metrics['total_revenue'], 2)); ?></div>
        </div>
        <div class="metric">
            <div class="metric-label">Total Orders</div>
            <div class="metric-value"><?php echo e(number_format($metrics['total_orders'])); ?></div>
        </div>
        <div class="metric">
            <div class="metric-label">Products Sold</div>
            <div class="metric-value"><?php echo e(number_format($metrics['products_sold'])); ?></div>
        </div>
        <div class="metric">
            <div class="metric-label">Avg Order Value</div>
            <div class="metric-value">$<?php echo e(number_format($metrics['avg_order_value'], 2)); ?></div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($product['quantity_sold']); ?></td>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/reports/pdf/report.blade.php ENDPATH**/ ?>