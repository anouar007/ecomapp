...
<body>
    <div class="invoice-container">
                    ...
                    <td style="width: 50%;">
                        <div class="company-info">
                            <?php if(setting('app_logo')): ?>
                                <img src="<?php echo e(public_path('storage/' . setting('app_logo'))); ?>" alt="Logo" style="max-height: 60px; margin-bottom: 10px;">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <br>
                            <?php if(setting('company_tax_id')): ?> ICE: <?php echo e(setting('company_tax_id')); ?><br> <?php endif; ?>
                            <?php if(setting('company_registry_id')): ?> RC: <?php echo e(setting('company_registry_id')); ?><br> <?php endif; ?>
                            <?php if(setting('company_patente')): ?> Patente: <?php echo e(setting('company_patente')); ?><br> <?php endif; ?>
            ...
            <div class="totals-row">
                <table>
                    <tr>
                        ...
                        <td class="value"><?php echo e($invoice->formatted_subtotal); ?></td>
                    </tr>
                </table>
            </div>
            <div class="totals-row">
                <table>
                    <tr>
                        <td class="label">Tax (<?php echo e($invoice->tax_rate); ?>%):</td>
                        <td class="value"><?php echo e($invoice->formatted_tax_amount); ?></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="totals-row">
                <table>
                    <tr>
                        ...
                        <td class="value">-<?php echo e($invoice->formatted_discount_amount); ?></td>
                    </tr>
                </table>
            </div>
            <?php endif; ?>
            <div class="totals-row totals-total">
                <table>
                    <tr>
                        ...
                        <td class="value"><?php echo e($invoice->formatted_total_amount); ?></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div style="margin-top: 20px; border: 1px solid #e2e8f0; padding: 10px; background: #f8fafc; border-radius: 4px;">
            ...
            <p style="font-style: italic; color: #333;">Stopped this invoice at the sum of: <strong><?php echo e($invoice->total_in_words); ?> <?php echo e(setting('currency_code', 'USD')); ?></strong></p>
        </div>
        ...
        <div class="footer-note">
            <p style="margin-bottom: 4px;"><?php echo e(setting('company_name')); ?> - <?php echo e(setting('company_address')); ?></p>
            <p>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/invoices/pdf.blade.php ENDPATH**/ ?>