...
<div class="brand-header mb-3">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?php echo e(route('pages.index')); ?>" class="btn btn-light me-2">Back</a>
...
<form id="page-form" action="<?php echo e(isset($page) ? route('pages.update', $page) : route('pages.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-6">
            <input type="text" name="title" class="form-control" placeholder="Page Title" value="<?php echo e(old('title', $page->title ?? '')); ?>" required id="input-title">
        </div>
        <div class="col-md-6">
            <div class="input-group">
                <span class="input-group-text"><?php echo e(url('/')); ?>/</span>
                <input type="text" name="slug" class="form-control" placeholder="slug" value="<?php echo e(old('slug', $page->slug ?? '')); ?>" required id="input-slug">
            </div>
        </div>
        <input type="hidden" name="layout" value="<?php echo e(old('layout', $page->layout ?? 'default')); ?>">
...
<script>
    ...
    let blocks = migrateBlocks(<?php echo json_encode(old('content_blocks', $page->content ?? []), 512) ?>);
    ...
    function loadMediaGallery() {
        ...
        fetch('<?php echo e(route("media.index")); ?>')
            .then(res => res.json())
            .then(images => {
                container.innerHTML = '';
                if(images.length === 0) {
    ...
    function setupMediaUploader() {
        ...
        input.addEventListener('change', () => {
            ...
            fetch('<?php echo e(route("media.store")); ?>', {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/pages/edit.blade.php ENDPATH**/ ?>