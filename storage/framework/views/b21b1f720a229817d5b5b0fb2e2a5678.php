...
<div class="brand-header ignore-print">
    <div>
        ...
        <p class="brand-subtitle">Période du : <span class="fw-bold text-dark"><?php echo e($startDate); ?></span> au <span class="fw-bold text-dark"><?php echo e($endDate); ?></span></p>
    </div>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('accounting.reports.cpc.pdf', ['start_date' => $startDate, 'end_date' => $endDate])); ?>" class="btn-brand-primary">
        ...
        <table class="brand-table">
            ...
            <tbody>
                ...
                <tr style="border-top: 1px dashed #cbd5e1;">
                    ...
                    <td class="text-end text-muted pe-4"><?php echo e(number_format($exploitation['total_produits'], 2)); ?></td>
                </tr>
                ...
                <tr style="border-top: 1px dashed #cbd5e1;">
                    ...
                    <td class="text-end text-muted pe-4"><?php echo e(number_format($exploitation['total_charges'], 2)); ?></td>
                </tr>
                ...
                <tr class="table-active" style="background-color: #f0fdf4;">
                    ...
                    <td class="text-end fw-bold text-success pe-4 py-3"><?php echo e(number_format($resultatExploitation, 2)); ?></td>
                </tr>
                ...
                <tr style="border-top: 1px dashed #cbd5e1;">
                    ...
                    <td class="text-end text-muted pe-4"><?php echo e(number_format($financier['total_produits'], 2)); ?></td>
                </tr>
                ...
                <tr style="border-top: 1px dashed #cbd5e1;">
                    ...
                    <td class="text-end text-muted pe-4"><?php echo e(number_format($financier['total_charges'], 2)); ?></td>
                </tr>

                <tr class="table-active" style="background-color: #f0fdf4;">
                    <td class="fw-bold text-success ps-4 py-3">VI. RÉSULTAT FINANCIER (IV - V)</td>
                    <td class="text-end fw-bold text-success pe-4 py-3"><?php echo e(number_format($resultatFinancier, 2)); ?></td>
                </tr>

                <tr style="background-color: #fef3c7;">
                    <td class="fw-bold text-warning ps-4 py-3">VII. RÉSULTAT COURANT (III + VI)</td>
                    <td class="text-end fw-bold text-warning pe-4 py-3"><?php echo e(number_format($resultatCourant, 2)); ?></td>
                </tr>
                ...
                <tr style="border-top: 1px dashed #cbd5e1;">
                    ...
                    <td class="text-end text-muted pe-4"><?php echo e(number_format($nonCourant['total_produits'], 2)); ?></td>
                </tr>
                ...
                <tr style="border-top: 1px dashed #cbd5e1;">
                    ...
                    <td class="text-end text-muted pe-4"><?php echo e(number_format($nonCourant['total_charges'], 2)); ?></td>
                </tr>

                <tr class="table-active" style="background-color: #f0fdf4;">
                    <td class="fw-bold text-success ps-4 py-3">X. RÉSULTAT NON COURANT (VIII - IX)</td>
                    <td class="text-end fw-bold text-success pe-4 py-3"><?php echo e(number_format($resultatNonCourant, 2)); ?></td>
                </tr>

                <!-- TOTAL -->
                <tr class="bg-primary text-white">
                    <td class="fw-bold ps-4 py-3">XI. RÉSULTAT NET (VII + X)</td>
                    <td class="text-end fw-bold pe-4 py-3"><?php echo e(number_format($resultatNet, 2)); ?></td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/accounting/reports/cpc.blade.php ENDPATH**/ ?>