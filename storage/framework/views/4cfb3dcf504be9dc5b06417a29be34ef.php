...
<div class="brand-card border-0 shadow-sm bg-white" data-aos="fade-up" data-aos-delay="100">
    <div class="card-body p-4 p-lg-5">
        <form action="<?php echo e(route('customer.profile.update')); ?>" method="POST" class="font-body">
            <?php echo csrf_field(); ?>
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" class="form-control border-light py-3 px-4 bg-light shadow-none focus-gold" value="<?php echo e(old('name', $user->name)); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold small text-muted text-uppercase ls-1">البريد الإلكتروني</label>
                    <input type="email" name="email" class="form-control border-light py-3 px-4 bg-light shadow-none focus-gold" value="<?php echo e(old('email', $user->email)); ?>" required>
                </div>
            </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/frontend/dashboard/profile.blade.php ENDPATH**/ ?>