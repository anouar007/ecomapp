...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('categories.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <input type="hidden" id="name_fr" name="name_fr" value="<?php echo e(old('name_fr')); ?>">
                <input type="hidden" id="name_en" name="name_en" value="<?php echo e(old('name_en')); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name_ar" name="name_ar" class="form-control" value="<?php echo e(old('name_ar')); ?>" placeholder="<?php echo e(__('Category Name (AR)')); ?>" dir="rtl" required oninput="syncTranslations()">
                </div>
            ...
            <input type="hidden" id="description_fr" name="description_fr" value="<?php echo e(old('description_fr')); ?>">
            <input type="hidden" id="description_en" name="description_en" value="<?php echo e(old('description_en')); ?>">
            ...
            <div class="form-group mt-3">
                ...
                <textarea id="description_ar" name="description_ar" class="form-control" rows="2" placeholder="<?php echo e(__('Description (AR)')); ?>..." dir="rtl" oninput="syncTranslations()"><?php echo e(old('description_ar')); ?></textarea>
            </div>
