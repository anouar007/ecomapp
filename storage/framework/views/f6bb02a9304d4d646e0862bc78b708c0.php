    ...
    <div class="row align-items-center g-3">
        ...
        <div class="col-12 col-lg text-center text-lg-start">
            <div class="d-flex flex-column flex-lg-row align-items-center gap-2 mb-2">
                ...
                <span class="brand-badge <?php echo e($order->status === 'delivered' ? 'success' : ($order->status === 'cancelled' ? 'danger' : 'info')); ?>">
        ...
        <div class="glass-card mb-4 border-0 shadow-soft overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <div class="mt-4 pt-4 border-top">
                    ...
                    <div class="brand-badge <?php echo e($order->payment_status === 'paid' ? 'success' : ($order->payment_status === 'failed' ? 'danger' : 'warning')); ?> w-100 justify-content-center py-3 fs-6 rounded-4">
                        <i class="fas fa-wallet me-2"></i> <?php echo e(__('Payment:')); ?> <?php echo e(__(ucfirst($order->payment_status))); ?>
