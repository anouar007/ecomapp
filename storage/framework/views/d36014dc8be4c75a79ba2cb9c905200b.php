            ...
            <div class="col-lg-3">
                <div class="brand-card border-0 shadow-sm overflow-hidden bg-white sticky-top" style="top: 100px;">
                    <div class="p-4 bg-gold-gradient text-white text-center">
                        ...
                        <h6 class="brand-heading h5 mb-0 text-white"><?php echo e(auth()->user()->name); ?></h6>
                        <small class="opacity-75 font-body" style="font-size: 0.75rem;"><?php echo e(auth()->user()->email); ?></small>
                    </div>
                    <div class="list-group list-group-flush font-body">
                        <a href="<?php echo e(route('customer.dashboard')); ?>" class="list-group-item list-group-item-action p-3 border-0 d-flex align-items-center gap-3 <?php echo e(request()->routeIs('customer.dashboard') ? 'bg-gold-light text-gold fw-bold border-start-gold' : 'text-muted'); ?>">
                            <i class="fas fa-columns opacity-50"></i> لوحة التحكم
                        </a>
                        <a href="<?php echo e(route('customer.orders')); ?>" class="list-group-item list-group-item-action p-3 border-0 d-flex align-items-center gap-3 <?php echo e(request()->routeIs('customer.orders*') ? 'bg-gold-light text-gold fw-bold border-start-gold' : 'text-muted'); ?>">
                            <i class="fas fa-shopping-bag opacity-50"></i> طلباتي الملكية
                        </a>
                        <a href="<?php echo e(route('customer.profile')); ?>" class="list-group-item list-group-item-action p-3 border-0 d-flex align-items-center gap-3 <?php echo e(request()->routeIs('customer.profile') ? 'bg-gold-light text-gold fw-bold border-start-gold' : 'text-muted'); ?>">
            ...
            <div class="col-lg-9">
                <?php if(session('success')): ?>
                    <div class="alert bg-gold-light text-dark border-gold-subtle alert-dismissible fade show rounded-3 mb-4 font-body" role="alert">
                        <i class="fas fa-check-circle me-2 text-gold"></i> <?php echo e(session('success')); ?>
    ...
    <div id="ai-chat-panel" class="brand-card shadow-lg border-gold-subtle">
        ...
        <div class="ai-chat-body font-body" id="ai-chat-body">
            <div class="ai-msg ai-msg-bot">
                مرحباً بكِ أميرتي <?php echo e(auth()->user()->name); ?>! 👋 أنا مساعدتكِ الشخصية في **<?php echo e(setting('app_name', 'Hijab Princesses')); ?>**. كيف يمكنني جعل تجربتكِ أكثر أناقة اليوم؟
            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/speed/resources/views/layouts/customer.blade.php ENDPATH**/ ?>