...
<div class="page-header">
    <h1 class="page-title"><i class="fas fa-user-plus"></i> {{ __('Add New Customer') }}</h1>
    <p class="page-subtitle">{{ __('Create a new customer profile') }}</p>
</div>
        ...
        <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> {{ __('Create Customer') }}
                </button>
            </div>
        </form>
    </div>
