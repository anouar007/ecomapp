                ...
                <div class="brand-card border-0 shadow-lg p-5 bg-white">
                    ...
                    <div class="bg-gold-light p-4 rounded-4 mb-5 text-start font-body border border-gold-subtle">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold text-gold h4 mb-0">{{ $order->formatted_total }}</span>
                        </div>
                    </div>

                    <div class="row g-3">
                        <div class="col-12">
                            <a href="{{ route('shop.index') }}" class="btn-brand-primary w-100 py-3 text-decoration-none hvr-grow">
