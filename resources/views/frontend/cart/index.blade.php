...
<div class="bg-light py-5">
    <div class="container">
        ...
        <div class="text-center py-5 mt-4">
            ...
            <p class="text-muted mb-4">Vous n'avez encore rien ajouté à votre panier.</p>
            <a href="{{ route('shop.index') }}" class="btn btn-primary rounded-pill px-5 py-3 fw-bold shadow-sm hover-scale-sm transition-transform">Commencer les achats</a>
        </div>
        @endif
    </div>
</div>
