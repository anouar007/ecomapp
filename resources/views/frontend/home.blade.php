...
<section class="hero-section overflow-hidden" 
         style="background: url('{{ asset('images/hero_flatlay.png') }}') no-repeat center center;">
    
    <div class="container position-relative" style="z-index: 3;">
        <div class="row align-items-center">
            {{-- Right-aligned text content to preserve the products on the left side of the flatlay --}}
            <div class="col-lg-7 text-white text-start" 
                ...
                <h1 class="fw-900 lh-sm mb-4 text-white font-title" style="font-size: clamp(2rem, 5vw, 3.5rem); text-shadow: 0 4px 15px rgba(0,0,0,0.3); font-family: 'Tajawal', sans-serif;">
                    {{ __('From the Atlas Mountains...') }}<br>
                    <span class="text-white">{{ __('To every home in the world') }}</span>
                </h1>
                ...
                <p class="mb-5 lh-lg text-white text-opacity-90" style="font-size: 1.1rem; max-width: 600px; text-shadow: 0 2px 8px rgba(0,0,0,0.2); font-family: 'Tajawal', sans-serif;">
                    {{ __('Hero Description Text') }}
                </p>

                {{-- Call-to-Action Buttons --}}
                <div class="d-flex flex-wrap gap-3 mb-4 justify-content-start">
                    <a href="{{ route('shop.index') }}" class="hero-cta-btn text-decoration-none d-inline-flex align-items-center gap-2">
                        {{ __('Acheter maintenant') }} <i class="fas {{ app()->getLocale() == 'ar' ? 'fa-chevron-left' : 'fa-chevron-right' }} small"></i>
                    </a>
                </div>

                {{-- Three organic trust badges inside hero bottom --}}
                <div class="d-flex flex-wrap align-items-center gap-3 mt-4 justify-content-start" style="font-family: 'Tajawal', sans-serif;">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="text-white small fw-bold">{{ __('100% Naturel') }}</span>
                    </div>
                    <span class="text-white opacity-50">|</span>
                    <div class="d-flex align-items-center gap-2">
                        <i class="fas fa-mountain text-white"></i>
                        <span class="text-white small fw-bold">{{ __('Au cœur de l\'Atlas') }}</span>
                    </div>
                    <span class="text-white opacity-50">|</span>
                    <div class="d-flex align-items-center gap-2">
                        <i class="fas fa-users text-white"></i>
                        <span class="text-white small fw-bold">{{ __('Coopératives féminines') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 align-items-center justify-content-around text-center">
            <div class="col-md-3 trust-item-box">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    ...
                    <div class="text-start">
                        <div class="fw-bold text-dark" style="font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">{{ __('Coopérative Agréée') }}</div>
                        <div class="x-small text-muted" style="font-family: 'Tajawal', sans-serif;">{{ __('Certifiée par l\'État') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 trust-item-box">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    ...
                    <div class="text-start">
                        <div class="fw-bold text-dark" style="font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">{{ __('Livraison Express') }}</div>
                        <div class="x-small text-muted" style="font-family: 'Tajawal', sans-serif;">{{ __('Partout au Maroc') }}</div>
                    </div>
                </div>
            </div>
            <div class="d-none d-md-block" style="width: 1px; background-color: rgba(14, 56, 32, 0.08); height: 40px;"></div>
            <div class="col-md-3 trust-item-box">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    ...
                    <div class="text-start">
                        <div class="fw-bold text-dark" style="font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">{{ __('Paiement Sécurisé') }}</div>
                        <div class="x-small text-muted" style="font-family: 'Tajawal', sans-serif;">{{ __('à la Livraison') }}</div>
                    </div>
                </div>
            </div>
        </div>
...
{{-- MAIN CONTENT SECTION (70% Products grid, 30% "قصتنا" card) --}}
    ...
    <div class="container py-3">
        <div class="row g-4 lg-g-5">
            ...
            <div class="col-lg-8" data-aos="fade-up">
                ...
                {{-- Header with view all link (Matched to image) --}}
                <div class="d-flex align-items-center justify-content-start mb-4">
                    <a href="{{ route('shop.index') }}" class="text-decoration-none text-dark fw-bold d-flex align-items-center gap-2" style="font-family: 'Tajawal', sans-serif; font-size: 1.15rem;">
                        <span>{{ __('Voir tout le catalogue') }}</span>
                        <i class="fas {{ app()->getLocale() == 'ar' ? 'fa-chevron-left' : 'fa-chevron-right' }} small" style="font-size: 0.8rem; margin-top: 3px;"></i>
                    </a>
                </div>
                ...
                <div class="text-center mt-5 {{ $hasMore ? '' : 'd-none' }}" id="load-more-container">
                    <button id="load-more-btn" class="btn-brand px-5 py-2.5 rounded-pill shadow-sm text-white border-0" style="background: #0e3820; font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">
                        {{ __('Charger Plus') }} <i class="fas fa-plus small ms-1"></i>
                    </button>
                </div>
            </div>
                ...
                <div class="sticky-sidebar" style="position: sticky; top: 100px;">
                    ...
                    <div class="story-card rounded-4 mb-4 overflow-hidden shadow-sm">
                        ...
                        <div class="cooperative-image-wrapper">
                            <img src="{{ asset('images/cooperative_story.png') }}" alt="Coop Story" class="w-100 h-auto object-fit-cover" style="display: block;">
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-5 bg-white border-top border-light" id="how">
    <div class="container py-3">
        <div class="text-center mb-5" data-aos="fade-up">
            <div class="section-label mx-auto" style="background: #fcf8f2; color: #bf8b43;">{{ __('Simple Process') }}</div>
            <h2 class="section-title fw-bold mt-2" style="font-size: 1.85rem; font-family: 'Tajawal', sans-serif;">{{ __('How It Works Title') }}</h2>
        ...
        <div class="row g-4 how-it-works-row">
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="{{ $i * 100 }}">
                <div class="step-item-card h-100">
                    ...
                    <div class="step-icon-container mb-4" style="background:{{ $s[2] }};">
                        <i class="fas {{ $s[1] }}" style="color:{{ $s[3] }}; font-size:1.2rem;"></i>
                    </div>
                    <h6 class="fw-bold mb-2 text-dark" style="font-size: 0.95rem;">{{ $s[4] }}</h6>
                    <p class="small text-muted mb-0 lh-lg" style="font-size: 0.82rem;">{{ $s[5] }}</p>
                </div>
            </div>
            @endforeach
        </div>
...
<section class="py-5" style="background:#fcfcfc;">
    <div class="container py-3">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-5" data-aos="fade-up">
                    <div class="section-label mx-auto">{{ __('FAQ Label') }}</div>
                    <h2 class="section-title fw-bold mt-2" style="font-size: 1.85rem; font-family: 'Tajawal', sans-serif;">{{ __('FAQ Title') }}</h2>
                ...
                <div class="accordion accordion-flush" id="faqAccordion">
                    ...
                    <div class="mb-3" data-aos="fade-up" data-aos-delay="{{ $i * 60 }}">
                        <div class="faq-accordion-item">
                            <button class="faq-accordion-btn {{ $i > 0 ? 'collapsed' : '' }}" type="button" data-bs-toggle="collapse" data-bs-target="#faq{{ $i }}">
                                <span class="d-flex align-items-center">
                                    <span class="me-3 text-green fw-900">{{ str_pad($i+1,'2','0',STR_PAD_LEFT) }}.</span>
                                    <span>{{ $faq[0] }}</span>
                                </span>
...
{{-- CONTACT AND SUPPORT CTA BANNER --}}
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-10">
                <div class="support-banner-card text-center" data-aos="zoom-in">
                    ...
                    <h3 class="fw-bold mb-3" style="font-family: 'Tajawal', sans-serif;">{{ __('Still have questions?') }}</h3>
                    <p class="mb-4 mx-auto" style="max-width:480px; font-size: 0.92rem;">
                        {{ __('Support Description') }}
                    </p>
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        <a href="https://wa.me/{{ str_replace(['+','  ',' '],'',(setting('app_phone','212600000000'))) }}" target="_blank" class="btn-brand wa-pulse-btn text-decoration-none">
                            <i class="fab fa-whatsapp"></i> {{ __('Chat on WhatsApp') }}
                        </a>
                        <a href="tel:{{ setting('app_phone','+212600000000') }}" class="btn-brand phone-outline-btn text-decoration-none">
...
{{-- FOOTER FEATURES CERTIFICATIONS STRIP --}}
        ...
        <div class="row g-4 justify-content-center text-center">
            <div class="col-6 col-md-3 cert-col">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <h6 class="fw-bold mb-1 text-dark" style="font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">{{ __('Produits 100% Naturels') }}</h6>
                </div>
            </div>
            <div class="col-6 col-md-3 cert-col">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <h6 class="fw-bold mb-1 text-dark" style="font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">{{ __('Sans Conservateurs') }}</h6>
                </div>
            </div>
            <div class="col-6 col-md-3 cert-col">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <h6 class="fw-bold mb-1 text-dark" style="font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">{{ __('Fait à la Main') }}</h6>
                </div>
            </div>
            <div class="col-6 col-md-3 cert-col">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <h6 class="fw-bold mb-1 text-dark" style="font-size: 0.95rem; font-family: 'Tajawal', sans-serif;">{{ __('Soutien aux Coopératives') }}</h6>
                </div>
            </div>
        </div>
    </div>
...
function fetchProducts() {
    ...
    .then(r => r.json()).then(data => {
        ...
        if(data.hasMore) { 
            ...
            btn.innerHTML = '{{ __("Charger Plus") }} <i class="fas fa-plus small ms-1"></i>'; 
            btn.disabled = false; 
        } else {
