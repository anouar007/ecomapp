            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tfoot class="bg-light">
                        <tr>
                            <td class="text-end pe-4 py-3 border-0">Subtotal</td>
                            <td class="text-end pe-4 py-3 border-0 fw-bold">${{ number_format($order->subtotal, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="text-end pe-4 py-2 border-0">Shipping</td>
                            <td class="text-end pe-4 py-2 border-0">${{ number_format($order->shipping_cost, 2) }}</td>
                        </tr>
                        <tr>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-4">
                <h6 class="fw-bold text-muted mb-3">SHIPPING ADDRESS</h6>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4">
                <h6 class="fw-bold text-muted mb-3">ORDER INFO</h6>
