...
<head>
    ...
    <title>{{ __('Create Account - Speed Store') }}</title>
    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle">{{ __('Join Speed Store and start shopping') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    >
                    <p class="password-requirements">{{ __('Password must be at least 8 characters') }}</p>
                    @error('password')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
