...
<div class="page-block-wrapper {{ $block['class'] ?? '' }}" 
    ...
    @switch($block['type'])
            ...
            <div class="py-5 w-100">
                 <div class="text-center">
                    <div class="p-5 rounded-4 shadow-sm text-white" style="@if(!empty($block['bg_image'])) background-image: url('{{ $block['bg_image'] }}'); background-size: cover; @endif; background: var(--brand-gold-gradient);">
                        <h2 class="brand-heading h1 mb-4 text-white">{{ $block['body'] ?? 'انضمي إلينا اليوم' }}</h2>
                        @if(!empty($block['cta_text']))
        ...
        @case('contact')
            <div class="py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5">
                        ...
                        <p class="font-body text-muted mb-5">{{ $block['body'] ?: 'نحن هنا لمساعدتِك في اختيار أفضل إطلالة تناسب جمالكِ.' }}</p>
                    </div>
                    <div class="col-lg-7">
         ...
         @case('product-grid')
            <div class="py-5 w-100">
                <h2 class="brand-heading text-center mb-5">{{ $block['body'] ?: 'أحدث التشكيلات' }}</h2>
