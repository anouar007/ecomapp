<tr>
            ...
            <div>
                ...
                @if($category->hasChildren())
                    <div class="mt-1" style="font-size: 0.65rem; color: var(--primary-color); font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em;">
                        <i class="fas fa-sitemap me-1"></i> {{ $category->children->count() }} {{ __('subcategories') }}
                    </div>
                @endif
            </div>
        </div>
    ...
    <td class="text-center">
        <span class="brand-badge info">
            <i class="fas fa-box me-1"></i> {{ $category->products_count }} {{ __('Products') }}
        </span>
    </td>
    <td class="text-center">
    ...
    <td style="padding-right: 1.5rem;">
        <div class="d-flex justify-content-end gap-2">
            <a href="{{ route('categories.edit', $category) }}" class="btn-action-icon" title="{{ __('Edit Category') }}">
