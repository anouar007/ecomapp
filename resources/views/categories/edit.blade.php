...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <input type="hidden" id="name_fr" name="name_fr" value="{{ old('name_fr', $category->name_fr ?: $category->name) }}">
                <input type="hidden" id="name_en" name="name_en" value="{{ old('name_en', $category->name_en) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name_ar" name="name_ar" class="form-control" value="{{ old('name_ar', $category->name_ar) }}" placeholder="{{ __('Category Name (AR)') }}" dir="rtl" required oninput="syncTranslations()">
                </div>
            ...
            <input type="hidden" id="description_fr" name="description_fr" value="{{ old('description_fr', $category->description_fr ?: $category->description) }}">
            <input type="hidden" id="description_en" name="description_en" value="{{ old('description_en', $category->description_en) }}">
            ...
            <div class="form-group mt-3">
                ...
                <textarea id="description_ar" name="description_ar" class="form-control" rows="2" placeholder="{{ __('Description (AR)') }}..." dir="rtl" oninput="syncTranslations()">{{ old('description_ar', $category->description_ar) }}</textarea>
            </div>
