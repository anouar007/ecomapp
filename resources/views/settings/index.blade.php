                    ...
                    <div class="settings-section">
                        ...
                        <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                <label class="form-label">{{ __('Application Name (FR)') }}</label>
                                <input type="text" name="settings[app_name_fr]" class="form-input" 
                                       value="{{ setting('app_name_fr') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{ __('Application Name (EN)') }}</label>
                                <input type="text" name="settings[app_name_en]" class="form-input" 
                                       value="{{ setting('app_name_en') }}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="form-label">{{ __('Application Name (AR)') }}</label>
                            <input type="text" name="settings[app_name]" class="form-input" 
                                   value="{{ $generalSettings->where('key', 'app_name')->first()?->value ?? '' }}" dir="rtl">
                        </div>

                        <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                <label class="form-label">{{ __('Application Description (FR)') }}</label>
                                <input type="text" name="settings[app_description_fr]" class="form-input" 
                                       value="{{ setting('app_description_fr') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{ __('Application Description (EN)') }}</label>
                                <input type="text" name="settings[app_description_en]" class="form-input" 
                                       value="{{ setting('app_description_en') }}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="form-label">{{ __('Application Description (AR)') }}</label>
                            <input type="text" name="settings[app_description]" class="form-input" 
                                   value="{{ $generalSettings->where('key', 'app_description')->first()?->value ?? '' }}" dir="rtl">
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="frontend-tab">
                    <div class="settings-section">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">{{ __('Footer Tagline (FR)') }}</label>
                                <textarea name="settings[frontend_footer_text_fr]" class="form-input" rows="2">{{ setting('frontend_footer_text_fr') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">{{ __('Footer Tagline (EN)') }}</label>
                                <textarea name="settings[frontend_footer_text_en]" class="form-input" rows="2">{{ setting('frontend_footer_text_en') }}</textarea>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">{{ __('Footer Tagline (AR)') }}</label>
                                <textarea name="settings[frontend_footer_text]" class="form-input" rows="3" dir="rtl">{{ setting('frontend_footer_text') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
